<%@  Control Language="C#" AutoEventWireup="true" CodeBehind="OrderReport.ascx.cs" Inherits="GoGetIt.OrderReport" %>
...
<script type="text/javascript">
    function ValidateDate() {
        ...
        if (vrStartDate == '') {
            ...
            window.location = "/handler/orderreport.ashx?startdate=" + vrStartDate + "&enddate=" + vrEndDate;
        }
        else {           
            alert('Exit');
        }       
