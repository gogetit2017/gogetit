...
#myModalAnuncion .modal-content {
    ...
    background-image: url(http://www.letusgogetit.com/images/close_work.jpg);
    height: 314px;
    }
    ...
    <div id="SignUpPane" runat="server" class="col-md-12" />
        ...
        <div class="navbar-header">
            ...
            <div class="navbar-brand">
                ...
                <a href="/home.aspx" ><img src="/images/newh_logo.png" class="imgLogoDiv img-responsive"/></a>
                </div>
            </div>
            <div class="nh-header">
              <span><a id="qquote" href="#quickquote" class="text-uppercase">quick quote</a></span>
              <a href="tel:+8669489506"><span>
                <img src="/images/newh_phone.png" class="img-responsive" alt="Image">
                866 948 9506
              </span></a>
              <span>10am 7pm</span>
            </div>
        ...
        <!--/.nav-collapse -->
               <!-- <div class="container">
                    <div class="col-md-12 img-call-now " >
                        <a href="tel:+8669489506" class="link_tel"><img src="/images/Call-Now.png" class="img-responsive" style="float: right;"/></a>
                    </div>
                </div>-->
    </div>
</div>
    ...
    <div class="container" id="drFooter">
       <!-- <div class="col-md-2">
		...
		<div class="col-sm-6 col-sm-offset-0">
            <div class="dvFooterLinks" id="maiaccount" style="padding:4px; " ><a href="/MyAccount.aspx" >My Account</a></div>
            <div class="dvFooterLinks" style="display:none;"><a href="/whatweare.aspx" >Who we are</a></div>
            <div class="dvFooterLinks" style="padding:4px; "><a href="/whatwedo.aspx" >About us</a></div>
            <div class="dvFooterLinks" style="padding:4px; "><a href="/FOR-BUSINESS/FOR-SMALL-BUSINESS" >For Small Business</a></div>
            <div class="dvFooterLinks" style="padding:4px; "><a href="/FOR-BUSINESS/FOR-ONLINE-BUSINESS" >For Online Business</a></div>
            <!--<div class="dvFooterLinks" style="padding:4px; "><a href="/featured-gets.aspx" >Featured gets</a></div>-->
            <div class="dvFooterLinks" style="padding:4px; "><a href="/faq.aspx" >faq</a></div>
            
            <div class="dvFooterLinks" style="padding:4px; "><a href="/Become-A-Go-Getter" >Become a go getter</a></div>
            <div class="dvFooterLinks" style="padding:4px; "><a href="/Contact-Us" >contact us</a></div>
            <div class="dvFooterLinks" style="padding:4px; "><a href="/home.aspx" >Home</a></div>           
            <!--<div class="dvFooterLinks" style="padding:4px; "><a href="/PrivacyPolicy" >Privacy Policy</a></div>
            <div class="dvFooterLinks" style="padding:4px; "><a href="/TOS" >Terms of Service</a></div>-->
        </div>
		<div class="col-sm-5 followus">
            Follow Us, We’re Social <br>
            <div class="dvFooterIcon2">
              <a target="_blank" href="https://twitter.com/letusgogetit">
                  <img src="/images/newh_tw.png" />
              </a>
          </div>
          
          <div class="dvFooterIcon2">
              <a target="_blank" href="https://www.facebook.com/LETUSGOGETIT">
                  <img src="/images/newh_fb.png" />
              </a>
          </div>

            <div class="dvFooterIcon2">
              <a target="_blank" href="https://www.instagram.com/letusgogetit">
                  <img src="/images/newh_insta.png" />
              </a>
            </div>
        </div>
        <div class="col-md-12 text-center">
            ...
            <div class="dvFooterLinks unique123"><span style="float:left; text-align:left;"><a style="    font-size: 14px;" href="/PrivacyPolicy">Privacy Policy</a> <a style="    font-size: 14px;" href="/TOS">Terms of Service</a></span>
            © 2017 Letusgogetit.com, All Rights Reserved.</div>
...
$('#qquote').click(function(){
            $("html,body").animate({scrollTop: $('#dnn_ctr521_ModuleContent').offset().top -100}, 1000); 
          });
...
var dato = $('#uname').val();
    ...
    if(dato != "")
    {
        $('#maiaccount').css('display', 'none');
    }
    else
    {
        $('#maiaccount').css('display', 'block');
    }
...
function onSuccessFarestimate(result) {
            ...
            var o = eval(result);
                    ...
                    if (o.success == true) {
                    $("#direccion").html("Your price is:<br>");
